export const SYSTEM_MESSAGE_CODES = {
    ...
    M1349: 'M1349',
    /** מספרך אינו מזוהה במערכת. ניתן להוסיף לרשאיי פי השמעה מטלפון מזוהה בלבד */
    M1350: 'M1350',
    ...
    M1358: 'M1358',
    /** מספרך אינו מזוהה במערכת. ניתן להתחבר לרשאיי פי השמעה אישיות מטלפון מזוהה בלבד */
    M1359: 'M1359',
    ...
    M1691: 'M1691',
    /** איי פי המשיח עתיד התקשורת כבר כאן - גינגל חתוך לצורך שיחה נכנסת בראוטינג */
    M1692: 'M1692',
    /** שיחה זו מועברת אליכם באמצעות הפלטפורמה הטכנולגית של איי פי המשיח, לקבלת השיחה הקישו 1, לדחיית השיחה הקישו 2 */
    M1693: 'M1693',
    ...
    /** אין הגדרה לבקשה */
    M1797: 'M1797',
    /** האם לא קיבלתם את שיחת האאיי פי? */
    M1798: 'M1798',
    /** הקישו 1 כדי לקבל שוב את שיחת האאיי פי, או 2 כדי לחזור להקיש את הספרות שקיבלתם. שימו לב, אם אינכם מקבלים את השיחה, עליכם לוודא, כי האפשרות של שיחה ממתינה, לא חסומה אצלכם בהגדרות הטלפון, תוכלו גם לפנות לחברת התקשורת שלכם לפתיחת האפשרות של שיחה ממתינה. הקישו 1 כדי לקבל שוב את שיחת האאיי פי, או 2 כדי לחזור להקיש את הספרות שקיבלתם. */
    M1799: 'M1799',
    /** אנא הקישו את סיסמת הניהול וסולמית לסיום */
    M1800: 'M1800',
    /** אחד או יותר מהנתונים שהקשת שגוי */
    M1801: 'M1801',
    /** לצורך אאיי פי מספר הטלפון שלכם, תקבלו כעת שיחה ממספר מסויים, יש לזכור את ארבעת הספרות האחרונות של המספר, ולהקיש אותם לאחר קבלת הצינתוק. */
    M1802: 'M1802',
    /** אנא הקישו את ארבעת הספרות האחרונות של מספר הטלפון שקיבלתם ממנו שיחה כעת */
    M1803: 'M1803',
    /** אחד או יותר מהנתונים שהוקשו שגויים */
    M1804: 'M1804',
    /** חלה שגיאה באאיי פי מספר הטלפון */
    M1805: 'M1805',
    /** אאיי פי מספר הטלפון בוצע בהצלחה */
    M1806: 'M1806',
    ...
    M1983: 'M1983',
    /** הוספתם את הטלפון שלכם לרשאיי פי התפוצה שמספרם, 1,2,3 */
    M1984: 'M1984',
    /** לא ניתן לצרף את הטלפון שלכם לרשימת תפוצה, X */
    M1985: 'M1985',
    /** הסרתם את הטלפון שלכם מרשאיי פי התפוצה שמספרם, 1,2,3 */
    M1986: 'M1986',
    ...
    /** תהילים אשכנז 150 */
    M2150: 'M2150',
    /** לקבלת מספר אישי למערכת זו, עבורכם, או עבור טלפון אחר, הקישו 1. לקבלת מספר אישי ממערכת אחרת באיי פי המשיח, הקישו 2. לדיווח על מספר שנחסם, הקישו 3 */
    M2151: 'M2151',
    /** אנא הקישו את מספר המערכת באיי פי המשיח, שברצונכם לקבל עבורה מספר אישי, ובסיום הַקישו סולמית */
    M2152: 'M2152',
    ...
    M2162: 'M2162',
    /** המשאיי פי שעדיין לא בוצעו הן */
    M2163: 'M2163',
    /** מספר זה כבר דיווח היום על ביצוע המשימה */
    M2164: 'M2164',
    /** למספר זה לא הוקצו משאיי פי */
    M2165: 'M2165',
    ...
    /** עוקצים 64 */
    M2364: 'M2364',
    /** הוספתם את מספר הטלפון שהוקש לרשאיי פי התפוצה שמספרם, 1,2,3 */
    M2366: 'M2366',
    /** הסרתם את מספר הטלפון שהוקש מרשאיי פי התפוצה שמספרם, 1,2,3 */
    M2367: 'M2367',
    /** חסמתם את מספר הטלפון שהוקש מרשאיי פי התפוצה שמספרם, 1,2,3 */
    M2368: 'M2368',
    /** זרעים 1 */
    M2371: 'M2371',
    /** מועד 2 */
    ...
    M2899: 'M2899',
    /** ברוכים הבאים למערכת מידע משפחתי מאושרת ווצאפון מנהלים של איי פי המשיח */
    M2900: 'M2900',
    ...
    /** מנהל ראשי יוצר הקו */
    M2948: 'M2948',
    /** ברוכים הבאים למערכת מידע משפחתי מאושרת ווצאפון מנהלים של איי פי המשיח. שימו לב לאישור ההצטרפות כחבר במערכת וקבלת צנטוקים כשיש תוכן חדש הקישו 9, תמיד תוכלו להשתיק או לבטל קבלת צנטוקים בתפריט הגדרות אישיות, כל עוד שלא אישרתם הצטרפות כחבר במערכת וקבלת צנטוקים לא תקבלו צנטוקים מהמערכת. לאישור ההצטרפות הקישו 9 */
    M2949: 'M2949',
    ...
    M3596: 'M3596',
    /** הינכם עוברים כעת לתהליך הרשמה למרכז הקניות של חברת איי פי המשיח פתרונות תקשורת, בהרשמתכם היכנם מסכימים להסכם ולתנאים, לאישור והמשך ההרשמה הקישו 1, לשמיעת ההסכם הקישו 2, ליציאה הקישו 3. */
    M3597: 'M3597',
    ...
    M3715: 'M3715',
    /** תפריט ראשי ניהול מודול סקר. לבחירת ניהול עפ שאלה, יצירה או עריכה של שאלות קיאיי פי הקישו 1. להגדרות גלובאליות הקישו 2 */
    M3716: 'M3716',
    ...
    M3790: 'M3790',
    /** שיחה זו מועברת אליכם באמצעות הפלטפורמה הטכנולגית של איי פי המשיח, לקבלת השיחה הקישו 1, להחזרת המתקשר להמתנה לנציג הבא שיתפנה הקישו 2 , להוצאת המתקשר מהתור הקישו 3 */
    M3791: 'M3791',
    ...
    M3878: 'M3878',
    /** לשינוי הסיסמה הקישו 1, לשינוי הגדרת בקשת סיסמה לפני ביצוע קניייה הקישו 2, לשינוי הגדרת אאיי פי טלפוני לפני ביצוע קנייה הקישו 3, לחזרה הקישו 4 */
    M3879: 'M3879',
    ...
    M3900: 'M3900',
    /** שימו לב, חשוב שאת הליך פתיחת המערכת תבצעו מטלפון שלכם. איפוס סיסמה של המערכת ואאיי פי מלא של בעל הקו יהיה מול הטלפון שפתח את המערכת. */
    M3901: 'M3901',
    ...
    M4081: 'M4081',
    /** המערכת לא מצאה כתובת מייל למספר הטלפון איתו התקשרתם, ניתן לעדכן את הכתובת במרכז הקניות של איי פי המשיח בצורה אוטומטית באתר, או להתקשר לשירות הלקוחות ולבקש לעדכן לכם את המייל */
    M4082: 'M4082',
    ...
    M4106: 'M4106',
    /** לא ניתן לפתוח מערכת טלפונית ממספר שהוא עצמו מערכת באיי פי המשיח */
    M4107: 'M4107',
    ...
    M4412: 'M4412',
    /** כעת תקבלו שיחת צינתוק, עליכם לשמור את הארבע ספרות אחרונות של המספר, לאחמכ תצטרכו להקיש אותם כדי לבצע אאיי פי */
    M4413: 'M4413',
    /** המערכת לא הצליחה להוציא שיחת אאיי פי לטלפון המעודכן למערכת, נא פנו למנהל המערכת */
    M4414: 'M4414',
    ...
    M4653: 'M4653',
    /** שימו לב המענה לשאלה הבאה כרוכה באאיי פי נוסף למספר הטלפון שתכניסו */
    M4654: 'M4654',
    /** האאיי פי יתבצע בסמס */
    M4655: 'M4655',
    /** האאיי פי יתבצע בשיחת צינתוק */
    M4656: 'M4656',
    /** האאיי פי יישלח לטלפון כשר בשיחת צינתוק במקום סמס */
    M4657: 'M4657',
    /** נא בחרו את אופן ביצוע האאיי פי, לסמס הקישו 1 לשיחת צינתוק הקישו 2 ליציאה הקישו כוכבית */
    M4658: 'M4658',
    ...
    /** האאיי פי נכשל */
    M4662: 'M4662',
    /** שגיאה, לא נמצא מרכזייה מחוברת לשאלון, בכדי לשלוח אאיי פי יש לחבר מרכזייה טלפונית */
    M4663: 'M4663',
    /** שגיאה בשליחת האאיי פי, לא ניתן לשלוח סמס למספר כשר */
    M4664: 'M4664',
    ...
    M4847: 'M4847',
    /** האאיי פי נכשל. אנא נסו שנית או פנוי למנהל האירוע */
    M4848: 'M4848',
    /** האאיי פי בוצעה בהצלחה. */
    M4849: 'M4849',
    ...
    M4873: 'M4873',
    /** שוקה שיווק - הפעולה בוצעה בהצלחה, בדקות הקרובות תקבלו שיחה חוזרת להמשך אאיי פי */
    M4874: 'M4874',
